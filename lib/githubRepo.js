...
class GithubRepo {
    ...
    checkIssueLastUpdatedByCollaborator(issue, checkEvents) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const latestEvent = allIssueEvents.reduce((prev, current) => prev.eventTime > current.eventTime ? prev : current);
