                ...
                if (this._eventsFromCollaborators.indexOf(event.event) !== -1) {
                    ...
                    switch (event.event) {
                        ...
                        case "unassigned":
                            ...
                            issueEvent = new IssueEvent(actor, event.event, new Date(event.created_at));
                            break;
                        default:
                            issueEvent = new IssueEvent(event.actor.login, event.event, new Date(event.created_at));
                            break;
                    }
